            ...
            <div class="content">
                ...
                <div class="flex-center" style="width:700px;">
                    <form action="{{ url('modify2') }}" method="post">
                      @csrf
                      <a href="{{ url('modify') }}" class="btn btn-default"><i class="fa fa-arrow-left"></i> 返回重新選擇</a>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control text-center" id="gameid" name="gameid" value="{{ $user->gameid }}" readonly>
                      </div>

                      <div class="form-group">
                        <label for="lineid">LINE名稱</label>
                        <input type="text" class="form-control text-center" id="lineid" name="lineid" value="{{ $user->lineid }}" readonly>
                      </div>
